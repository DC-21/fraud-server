...
exports.registerUser = async (req, res) => {
  try {
    const { username, password, email, full_name,account_number,balance } = req.body;
    ...
    const user = new User({ username, password: hashedPassword, email, full_name,account_number,balance });
